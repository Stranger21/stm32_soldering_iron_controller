...
- **Tip change mode**<br>
  While in the main temperature screen, issue a Long-click for 1-2sec, after which a screen with a soldering tip and an arrow will be displayed.<br>
...
- **System menu**<br>
  A Very long click (3 and more) will enter the system menu (Except while in tip selection/setpoint adjustment).<br>

...
const strings_t strings[LANGUAGE_COUNT] = {
    ...
    [lang_english] = {
      ...
      .main_mode_Sleep = "STBY",
      .main_mode_Sleep_xpos = 42,
      .main_mode_Standby = "SLEEP",
	  ...
	  .SYSTEM_ChngPin = "ChngPin",
	  .SYSTEM_TipChg_Time = "Time Change",
      .SYSTEM_Battery = "Battery",
	  .SYSTEM_AutoSwitchSet = "AutoProfile",
	  .SYSTEM_T12volt = "  T12 volt",
	  .SYSTEM_C245volt = " C245 volt",
	  .SYSTEM_C210volt = " C210 volt",
	  .SYSTEM_C115volt = " C115 volt",
	  .SYSTEM_T12NTC = "  T12 kom",
	  .SYSTEM_C245NTC = " C245 kom",
	  .SYSTEM_C210NTC = " C210 kom",
	  .SYSTEM_C115NTC = " C115 kom",
	  .SYSTEM_NTC_pullup = " NTC pull",
      .SYSTEM_DEBUG = "DEBUG",
    ...
    [lang_russian] = {
      ...
      .IRON_Cold_Boost = "ХолоднБуст",
      .IRON_ColdBoost_Threshold = " Порог Т",
      .IRON_ColdBoost_Timeout = " Время",
	  ...
	  .SYSTEM_ChngPin = "Вхд смены",
	  .SYSTEM_TipChg_Time = "Время смены",
      .SYSTEM_Battery = "Батарея",
	  .SYSTEM_AutoSwitchSet = "АвтоПрофиль",
	  .SYSTEM_T12volt = "  T12 вольт",
	  .SYSTEM_C245volt = " C245 вольт",
	  .SYSTEM_C210volt = " C210 вольт",
	  .SYSTEM_C115volt = " C115 вольт",
	  .SYSTEM_T12NTC = "  T12 ком",
	  .SYSTEM_C245NTC = " C245 ком",
	  .SYSTEM_C210NTC = " C210 ком",
	  .SYSTEM_C115NTC = " C115 ком",
	  .SYSTEM_NTC_pullup = " NTC pull",

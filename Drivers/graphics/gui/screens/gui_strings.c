...
const strings_t strings[LANGUAGE_COUNT] = {
    ...
    [lang_english] = {
	  ...
	  .SYSTEM_ChngPin = "ChngTipPin",
	  .SYSTEM_TipChg_Time = "ChngTipTime",
      .SYSTEM_Battery = "Battery",
	  .SYSTEM_AutoSwitchSet = "AutoProfile",
	  .SYSTEM_T12volt = "  T12v",
	  .SYSTEM_C245volt = " C245v",
	  .SYSTEM_C210volt = " C210v",
	  .SYSTEM_C115volt = " C115v",
	  .SYSTEM_T12NTC = "  T12r",
	  .SYSTEM_C245NTC = " C245r",
	  .SYSTEM_C210NTC = " C210r",
	  .SYSTEM_C115NTC = " C115r",
	  .SYSTEM_NTC_pullup = " NTCpl",
      .SYSTEM_DEBUG = "DEBUG",
